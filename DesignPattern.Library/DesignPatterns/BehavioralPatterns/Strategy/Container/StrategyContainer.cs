using DesignPatterns.BehavioralPatterns.Strategy.Examples.Sorting;
using DesignPatterns.BehavioralPatterns.Strategy.Pattern;
using DesignPatterns.Extensions;
namespace DesignPatterns.BehavioralPatterns.Strategy.Container
{
