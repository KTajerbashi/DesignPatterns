using DesignPatterns.BehavioralPatterns.TemplateMethod.Examples.CardRegister.MailRepository;

namespace DesignPatterns.BehavioralPatterns.TemplateMethod.Examples.CardRegister.CardService
{
